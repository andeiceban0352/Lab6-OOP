...
#include "source/model/operator.h"
#include "source/model/ride_type.h"
#include "source/model/person.h"
#include "source/model/economy_management.h"
#include "source/model/driver.h"
#include "source/model/customer.h"
#include "source/model/car.h"
#include "source/model/admin.h"
#include "source/model/booking.h"
#include "cstdlib"
#include "stdlib.h"
#include "unistd.h"
...
int main()
{
    ...
    while(true){
        ...
        for(int i = 0; i < book_x.nr_of_commands; i++){
            ...
            string driver = driver_x.get_the_command(drv_nr);
            ...
            driver_rating = customer_x.leave_rating();
            customer_x.get_out_from_car();

            if(car_x.model[car] == "Audi"){
                ride_x.ride_price = ride_x.ride_price_stnd(distance);
                car_x.fuel_standard = ((distance*8)/100) * 27.3;
                eco_x.cheltuieli = eco_x.cheltuieli + car_x.fuel_standard; 
                displayDistance(distance);
                cout << "Fuel_standard : " << car_x.fuel_standard << " lei" << " | ";
                cout << "Rideprice : " << ride_x.ride_price << " lei" << " | ";
                cout << "\n";
            }else if(car_x.model[car] == "Porche"){
            ...
            else if(car_x.model[car] == "Bmw"){
                ride_x.ride_price = ride_x.ride_price_stnd(distance);
                car_x.fuel_standard = ((distance*10)/100) * 27.7;
                eco_x.cheltuieli = eco_x.cheltuieli + car_x.fuel_standard; 
                displayDistance(distance);
                cout << "Fuel_standard : " << car_x.fuel_standard << " lei" << " | ";
                cout << "Rideprice : " << ride_x.ride_price << " lei" << " | ";
                ...
                ride_x.ride_price = ride_x.ride_price_stnd(distance);
                car_x.fuel_standard = ((distance*6)/100) * 27.7;
                eco_x.cheltuieli = eco_x.cheltuieli + car_x.fuel_standard; 
                displayDistance(distance);
                cout << "Fuel_standard : " << car_x.fuel_standard << " lei" << " | ";
                cout << "Rideprice : " << ride_x.ride_price << " lei" << " | ";
                ...
                ride_x.ride_price = ride_x.ride_price_stnd(distance);
                car_x.fuel_standard = ((distance*4)/100) * 27.7;
                eco_x.cheltuieli = eco_x.cheltuieli + car_x.fuel_standard; 
                displayDistance(distance);
                cout << "Fuel_standard : " << car_x.fuel_standard << " lei" << " | ";
                cout << "Rideprice : " << ride_x.ride_price << " lei" << " | ";
